...
<?php
        ...
        if ($registrerOppgaveKnapp)  /*knappen til å skrive til fil er trykket*/
        {
            ...
            {
                 print("Fagkode er ikke korrekt fylt ut n<br/>");
            }
            
            if (!$lovligOppgavenr) /* oppgavenr er ikke korrekt fylt ut */
            {
                 print("Oppgavenr er ikke korrekt fylt ut n<br/>");
            }
              
             if ($lovligFagkode  && $lovligOppgavenr ) /* Ingen feil funnet */
